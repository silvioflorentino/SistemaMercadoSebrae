...
<div class="container">
<form action="<?=base_url('Home/logar');?>" method="Post" style="padding: 20%">
  <div class="mb-1">
  ...
  <a href="<?=base_url('Home/buscatelanovasenha');?>"><button type="button" class="btn btn-primary">Esqueci a senha</button></a>
</form>
</div>
</body>
</html>